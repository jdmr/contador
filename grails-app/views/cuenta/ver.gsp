...
<html>
    ...
    <body>
        ...
        <div class="body">
            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="cuenta.id.label" default="Id" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: cuenta, field: "id")}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean: cuenta, field: "nombre")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="cuenta.descripcion.label" default="Descripcion" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: cuenta, field: "descripcion")}</td>
            ...
            <div class="buttons">
                <g:form>
                    <g:hiddenField name="id" value="${cuenta?.id}" />
